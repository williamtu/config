...
ip link add dev ip6gretap11 type ip6gretap key 102 \
         local fc00:100::2 \
        remote fc00:100::1

ip addr add dev ip6gretap11 fc00:200::2/96
ip addr add dev ip6gretap11 10.10.200.2/24
...
# Tunnel
ip netns exec ns0 ip link add dev ip6gretap00 type ip6gretap key 102 \
     local fc00:100::1 \
    remote fc00:100::2

ip netns exec ns0 ip addr add dev ip6gretap00 fc00:200::1/96
ip netns exec ns0 ip addr add dev ip6gretap00 10.10.200.1/24

ip netns exec ns0 ip link set dev ip6gretap00 up
