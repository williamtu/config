...
ovs-vsctl add-port br0 at_erspan0 -- \
              ...
              options:erspan_ver=2 options:erspan_dir=1 options:erspan_hwid=3 
...
ip netns exec at_ns0 sh << NS_EXEC_HEREDOC
ip link add dev ns_erspan0 type erspan seq key 1 erspan_ver 2 erspan_dir egress erspan_hwid 3 remote 172.31.1.100
